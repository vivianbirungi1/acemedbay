...
// Route::get('/admin/patients/{id}/visits/create', [AdminVisitController::class, 'create'])->name('admin.visits.create');
// Route::post('/admin/patients/{id}/visits/store', [AdminVisitController::class, 'store'])->name('admin.visits.store');
// Route::delete('/admin/patients/{id}/visits/{rid}', [AdminVisitController::class, 'destroy'])->name('admin.visits.destroy');
...
// Route::delete('/admin/doctors/{id}/visits/{rid}', [AdminVisitController::class, 'destroy'])->name('admin.visits.destroy');
