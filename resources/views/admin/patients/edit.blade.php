       ...
       <div class="card-body">
        ...
        <form action="{{ route('admin.patients.update', $patient->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="phone" id="name" value="{{ old('phone' , $patient->user->phone) }}" />
                </div>
                <div class="form-group">
                    <label for="email">Email</label>
                    <input type="email" class="form-control" name="email" id="email" value="{{ old('email' , $patient->user->email) }}" />
                </div>
